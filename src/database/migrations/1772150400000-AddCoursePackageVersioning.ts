...
export class AddCoursePackageVersioning1772150400000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course_packages" DROP COLUMN "effectiveEndDate"`);
        await queryRunner.query(`ALTER TABLE "course_packages" DROP COLUMN "effectiveStartDate"`);
    }
}
