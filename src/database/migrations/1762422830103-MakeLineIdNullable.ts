...
export class MakeLineIdNullable1762422830103 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "parents" ALTER COLUMN "lineId" DROP NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "parents" ALTER COLUMN "lineId" SET NOT NULL`);
