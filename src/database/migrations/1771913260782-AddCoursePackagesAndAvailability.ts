...
export class AddCoursePackagesAndAvailability1771913260782 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "idx_teacher_availability_teacher_date" ON "teacher_availability" ("teacherId", "date")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "idx_teacher_availability_teacher_date"`);
